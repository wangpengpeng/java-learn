package com.wpp.aleetcode.problem.two_pointers;
 ...
 *
 * Solution: O((w + S) x N (no of words))
 * Using two pointers technique check if each of the given string is a sub-sequence of the main string.
 *
 */
